...
# -*- coding: utf-8 -*-
"""
Setup isolated workdirs for generate-sls-skill eval runs.

IMPORTANT: generate-sls-skill requires execution within workdir.
...
Example:
    # Single run
    setup_workdir.py generate-sls-skill-workspace/iteration-1 eval-bill-analysis evals/fixtures/bill-analysis-xxx
...
def main():
    ...
    parser.add_argument("iteration_dir", type=Path, help="Iteration directory (e.g. generate-sls-skill-workspace/iteration-2)")
