#!/usr/bin/env python3
"""
Prepare a logstore input directory for SKILL knowledge generation.
...
Output:
  ...
  <input_dir>/fragments/:
    - datasource.md        # Embed directly into the reference doc
"""
...
def generate_datasource_md(project_name: str, logstore_name: str) -> str:
    ...
    is merely a sample value.  Writing it into the generated docs would be
